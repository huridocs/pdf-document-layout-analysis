...
from adapters.external_services.external_format_service_adapter import ExternalFormatServiceAdapter
...
def setup_dependencies():
    ...
    external_format_service = ExternalFormatServiceAdapter()
    ...
    pdf_analysis_service = PDFAnalysisServiceAdapter(
        ...
        external_format_service=external_format_service,
